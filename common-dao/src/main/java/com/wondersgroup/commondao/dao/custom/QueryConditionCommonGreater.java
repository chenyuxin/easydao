 ...
 * 添加自定义为大于筛选的查询条件
 */
public class QueryConditionCommonGreater extends QueryCondition {
	...
	/**
	 * 添加自定义为'大于'的筛选的查询条件初始化
	 * @param fieldName 数据库字段名
	 * @param fieldValue 参数值
	 * @param paramName 参数变量名,如定义的值与原本查询条件的参数变量相同，将覆盖原本查询条件的参数值！请注意！
	 * @param equalFlag 判断是否为大于等于,false只有 '>',true为'>='
	 */
	public QueryConditionCommonGreater (String fieldName,Object fieldValue,String paramName,boolean equalFlag) {
		super();
