...
import com.wondersgroup.commondao.dao.daoutil.anotation.Column;
...
public class CommonSql {
	...
	public static String selectSql4Map(List<String> attributeNames, String tableName, int pageNo, int pageSize,
			DataBaseType dataBaseType, Map<String, Object> paramMap, QueryCondition... queryConditions) {
		StringBuffer sBuffer = new StringBuffer();
		if (DataBaseType.MYSQL.equals(dataBaseType)){
			sBuffer.append("select ");
			for(int i=0;i<attributeNames.size();i++){
		...
		} else if (DataBaseType.POSTGREPSQL.equals(dataBaseType)){
			sBuffer.append("select ");
			for(int i=0;i<attributeNames.size();i++){
				sBuffer.append(attributeNames.get(i));
				if (i!=attributeNames.size()-1){
	 ...
	 * @return
	 */
	public static <T> String selectSql4Obj(Class<T> clazz, int pageNo, int pageSize, DataBaseType dataBaseType,
	 ...
	 * @return
	 */
	public static String pageing(String sql, int pageNo, int pageSize, DataBaseType dataBaseType) {
