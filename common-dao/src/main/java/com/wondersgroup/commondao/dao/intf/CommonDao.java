package com.wondersgroup.commondao.dao.intf;
...
public interface CommonDao {
	...
	/**
	 * 移除对应表的程序缓存
	 * 当配置了查询缓存时，又不想让某次查询读缓存而直接去查数据库时可先执行此操作。
	 * @param tableType 含有表名的表类型(必填)
	 * @param daoOptions 可选设置参数{ dataSourceName 其它数据源在spring配置文件bean的id}
	 * @param dataSourceName 其它数据源在spring配置文件bean的id
	 * @return
	 */
	String delCache(TableType tableType, Object... daoOptions);
